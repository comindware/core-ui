...
define(['text!./templates/passwordEditor.html', './base/BaseItemEditorView'],
    function (template, BaseItemEditorView) {
        ...
        var defaultOptions = {
            changeMode: 'blur',
            emptyPlaceholder: Localizer.get('CORE.FORM.EDITORS.PASSWORD.PLACEHOLDER'),
            maxLength: null,
            readonly: false
        };

        Backbone.Form.editors.Password = BaseItemEditorView.extend({
