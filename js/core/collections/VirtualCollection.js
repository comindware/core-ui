...
define(['core/libApi', '../models/behaviors/SelectableBehavior', 'core/utils/utilsApi'],
    function (lib, SelectableBehavior, utils) {
        'use strict';
        ...
        function getNormalizedGroupingIterator (groupingOptions) {
        ...
        function getNormalizedGroupingComparator (groupingOptions) {
        ...
        function fixGroupingOptions (groupingOptions) {
        ...
        var VirtualCollection = Backbone.Collection.extend(/** @lends module:core.collections.VirtualCollection.prototype */ {
            ...
            __onAdd: function (model, collection, options) {
                ...
                if (options.delayed !== false && this.options.delayedAdd) {
                    utils.helpers.nextTick(function ()
                    {
                        this.__rebuildIndex();
                        this.trigger('reset', this, options);
