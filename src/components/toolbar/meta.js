...
export const icons = {
    ...
    Plus: {
        text: 'Plus',
        id: 'Plus',
        icon: '<svg viewBox="0 0 14 14"><path class="d-svg-icons d-svg-icons_plus" d="M13,6H8V1c0-0.6-0.4-1-1-1S6,0.4,6,1v5H1C0.4,6,0,6.4,0,7s0.4,1,1,1h5v5c0,0.6,0.4,1,1,1s1-0.4,1-1V8h5 c0.6,0,1-0.4,1-1S13.6,6,13,6z"/></svg>'
    },
    Minus: {
        text: 'Minus',
        id: 'Minus',
    ...
    Remove: {
        text: 'Remove',
        id: 'Remove',
        icon: '<svg viewBox="0 0 14 14"><polygon  class="d-svg-icons d-svg-icons_remove" points="14,1.8 12.2,0 7,5.2 1.8,0 0,1.8 5.2,7 0,12.2 1.8,14 7,8.8 12.2,14 14,12.2 8.8,7 "/></svg>'
    },
    Trash: {
        text: 'Trash',
        id: 'Trash',
