 ...
 * @param {String, Number} [max, min] Max, min value. Type - like arg for moment.duration
 * */
...
export default (formRepository.editors.Duration = BaseItemEditorView.extend({
    ...
    checkMaxMinObject(valueObject, max, min) {
        ...
        return dateHelpers.durationISOToObject(result); //durationISOToObject can takes any type arg, like arg for moment.duration
    },
